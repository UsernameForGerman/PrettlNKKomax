...
urlpatterns = [
    ...
    re_path(r'^komax_tasks/(?P<task_name>[a-zA-Z0-9_.-]*)/get_task_komax/(?P<komax>\d+)/$', views.get_personal_task_view_komax, name='get_spec_task'),
    re_path(r'^komax_tasks/(?P<task_name>[a-zA-Z0-9_.-]*)/get_task_kappa/(?P<kappa>\d+)/$', views.get_personal_task_view_kappa, name='get_spec_task_kappa'),
